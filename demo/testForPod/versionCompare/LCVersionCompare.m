...
@interface LCVersionCompare()<UIAlertViewDelegate>
...
- (void)versionAlert
{
    switch (_isUpdate) {
        case QUpdateMust:
        {
            UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"提示" message:[NSString stringWithFormat:@"发现新版本%@,请更新!", _myNewVersion]  delegate:self cancelButtonTitle:@"更新" otherButtonTitles:nil, nil];
            [alert show];
            break;
        }
        case QUpdateYes:
        {
            UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"提示" message:[NSString stringWithFormat:@"发现新版本%@,请更新!", _myNewVersion] delegate:self cancelButtonTitle:@"更新" otherButtonTitles:@"取消", nil];
            [alert show];
            break;
        }
        case QUpdateNO:
